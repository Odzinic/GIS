...
final_values = {}                                                                       # Dictionary that holds the extracted 
                                                                                        # z values in format z = final_values[x_value][y_value]
...
'''Load images into stack'''
    # Loops through the image folder and adds the images
    # into a 3D list/array
